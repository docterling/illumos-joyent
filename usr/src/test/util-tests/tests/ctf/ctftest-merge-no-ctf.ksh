...
fail_no_ctf $CTFMERGE -o files.o file2.o file1.o
ld -r -o files.o file2.o file1.o
$CTFMERGE -m -o files.o file2.o file1.o
has_ctf files.o
$CC -o mybin file2.o file1.o
fail_no_ctf $CTFMERGE -o mybin file2.o file1.o
$CC -o mybin file2.o file1.o
$CTFMERGE -m -o mybin file2.o file1.o


echo "$progname: ctfmerge should allow a .cc file to lack CTF"
$CC -c -o file3.o file3.cc
ld -r -o files.o file1.o file3.o
$CTFMERGE -o files.o file1.o file3.o
ld -r -o files.o file1.o file3.o
$CTFMERGE -m -o files.o file1.o file3.o

echo "$progname: ctfmerge should allow an .s file to lack CTF"
as -o file4.o file4.s
ld -r -o files.o file4.o file1.o
$CTFMERGE -o files.o file4.o file1.o
ld -r -o files.o file4.o file1.o
$CTFMERGE -m -o files.o file4.o file1.o
